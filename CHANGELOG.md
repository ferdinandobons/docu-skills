...
A post-0.8.0 review hardening pass. Generated bytes are unchanged for
well-formed templates and profiles (frozen anchor verified); the fixes close
crash/corruption windows on malformed or adversarial input and pin the QA
check-id vocabulary.
